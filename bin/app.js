...
var educationView =
  ...
  // 'fa-li' is replaced by 'left--2 absolute w2 tc'
  var icon =
      m('span', {class: 'left--2 absolute w2 tc'}, m(Icon, {name: 'grad'}))
  ...
  var children =
      [
        icon, m('span', {class: 'black'}, ed.degree), ' in ', ed.department,
        ', ', ed.year, m('br'),
        m('div', {class: 'dark-gray f7 f6-ns'}, university)
      ]
  ...
  view: function() {
    var img = m('img', {
      ...
      title: 'Abhay Singh Bhadoriya'
    });

    var title =
        m('h2', {class: 'f3-ns f4 mb3 black'}, 'Postdoctoral Researcher')
    ...
    var subTitle =
        m('h2', {class: 'f5-ns f6 fw4 dark-gray mt1'},
    ...
    var scholar = m(
        ...
        m('i', {class: 'ai ai-google-scholar ai-2x black-70 hover-blue grow'}));
    ...
    var card =
        m('article', {class: 'w-50-ns w-100-m mw6 bg-white br3 pa2 mv3'},
          [pic, icons]);


    var education =
        m('ul', {class: 'list pl0 ml4 relative f6 f5-ns'},
          Education.list.map(educationView))
    var edTitle =
        m('h4', {class: 'f5-ns f6 ttu tracked mb2 black'}, 'EDUCATION')
    var edRow = m('div', {class: 'dt-row'}, [edTitle, education])

    var desc = m(
        'p', {class: 'measure-wide w-50-ns w-100-m f6 f5-ns lh-copy pa2 tl'}, [
          Bio.biography, ' ',
          Bio.research,  //' ',
          // Bio.softwares,
          edRow
    ...
    var home =
        m('div', {
          class:
              'flex flex-column flex-row-l cf-ns nl2 nr2 nt6-ns justify-center items-center-m'
        },
          [card, desc])
...
module.exports = {
    view: function() {
        return m('div', {class: 'pa3 ph5-ns w-100'}, [
            // m('h1', {class: 'f3 f2-ns fw6 black-70 mt0'}, 'Projects'),
            m('div', {class: 'project'}, [
                ...
                m('div', {class: 'w-60 mt3'}, [ // Description container with 100% width and top margin
                    m('p', {class: 'f5 f4-ns lh-copy tj'},
                        ...
                        m('a', {href: 'https://ieeexplore.ieee.org/abstract/document/10230292', target: '_blank', class: 'link blue'}, ' IEEE Transaction on Automation Science and Engineering, 2023')
                    )
                ]),
                
            ]),

            m('div', {class: 'project mt4'}, [
                m('h2', {class: 'f4 f3-ns fw6 black-70'}, 'Vehicle Detection and Tracking Using Thermal Cameras in Adverse Visibility Conditions'),
                m('div', {class: 'w-60'}, [
                    m('div', {class: 'video-container'}, [
                        m('iframe', {width: '100%', height: '550', src: 'https://www.youtube.com/embed/J4EtQSkiTvE', frameborder: '0', allow: 'accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture', allowfullscreen: true}),
                    ])
                ]),
...
const Icon = {
  ...
  view: function() {
    var icon = m(
        'span', {class: 'left--2 absolute w2 tc'}, m(Icon, {name: 'research'}))

    var theoryTitle = m('h3', {class: 'f6 ttu tracked nt2 black'}, 'THEORY');
    var appliedTitle =
        m('h3', {class: 'f6 ttu tracked nt2 black'}, 'APPLICATION DOMAINS');
    ...
    var theorylist =
        m('ul', {class: 'list pl0 ml4 relative f6 f5-ns'}, theoryItems);
    var theorydiv =
        m('div', {id: 'theory', class: 'fl pa2 ph5-l'},
          [theoryTitle, theorylist]);

    var appliedItems = Bio.appliedInterests.map(function(item) {
      return m('li', {class: 'pa2 lh-copy'}, [icon, item])
    });
    var appliedlist =
        m('ul', {class: 'list pl0 ml4 relative f6 f5-ns'}, appliedItems);
    var applieddiv =
        m('div', {id: 'applied', class: 'fl pa2 ph5-l'},
          [appliedTitle, appliedlist]);

    return m(
        'div', {
          class:
              'flex flex-column items-start nt6-ns nt3 cf-ns nl2 nr2  pt4 pl3'
        },
        [theorydiv, applieddiv]);
  }
}
...
const ProjectsBox = __webpack_require__(/*! ./views/ProjectsBox */ "./src/views/ProjectsBox.js");
